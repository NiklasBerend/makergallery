...
<div class="wrapper">
        ...
        <div class="info">
    		<div class="left">
        		<div class="iframe-container">
                     ...
                     <div class="creator">
                    	<strong>Urheber:</strong> <a href="http://wiki.medialiteracylab.de/index.php?title=MakeyMakeyMainz" target="_blank">AG MakeyMakey Mainz</a> | Niklas Berend, Jonas Cussler, Nina Aue, Sarah Kollross, Christina Sendobry, Merle Flemming, Xenia Likai 
                    </div>
                    <div class="license">
    ...
    <p style="text-align: justify">Die Arbeitsgruppe MakeyMakeyMainz 
