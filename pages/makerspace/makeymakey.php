...
<div class="wrapper">
        ...
        <div class="info">
    		<div class="left">
        		<div class="iframe-container">
                     ...
                     <div class="creator">
                    	<strong>Urheber:</strong> Niklas Berend, Jonas Cussler, Nina Aue, Sarah Kollross, Christina Sendobry, Merle Flemming, Xenia Likai 
                    </div>
                    <div class="license">
    ...
    <p style="text-align: justify">Die Arbeitsgruppe MakeyMakeyMainz hat in einer Grundschule im Rhein-Main(z)-Gebiet das MaKeyMaKey          ausprobiert.
