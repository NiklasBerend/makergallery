...
<div class="wrapper">
        ...
        <div class="info">
    		<div class="left">
        		<div class="iframe-container">
                     ...
                     <div class="creator">
                    	<strong>Urheber:</strong> AG Kodu Mainz 
                    </div>
                    <div class="license">
            ...
            <div class="right">
                ...
                <ul>
                	<li><span>///</span></li>
                	<li><span>Kodu</span></li>
                    <li><span>Welten</span></li>
                    <li><span>Programmieren</span></li>
                    <li><span>Erkunden</span></li>
                    <li><span>\\\</span></li>
                </ul>
            </div>
          </div>
    ...
    <p style="text-align: justify">Kodu ist eine Programmiersprache für Kinder, mit deren Hlfe sich neue Welten gestalten und von Fremden gestaltete Welten erkunden lassen. Wir haben fürs #mlab14 ebenfalls eine Welt erstellt, die ihr hier erkunden könnt! Ihr findet sie <a href="http://www.so.cl/#/post?i=2L1mkvZiobKHaKnj" target ="_blank">hier</a> </p>
